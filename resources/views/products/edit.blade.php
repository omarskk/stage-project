...
@endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="modele_id" id="modele_id" required
                                    ...
                                    @foreach($product->brand->modeles as $modele)
                                        <option value="{{ $modele->id }}" {{ $modele->id == $product->modele_id ? 'selected' : '' }}>
                                            {{ $modele->nom }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input name="price" type="number" value="{{ old('price', $product->price) }}" step="0.01" required
                            ...
                            <div>
                                ...
                                <input name="quantity" type="number" value="{{ old('quantity', $product->quantity) }}" required
                                       class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                        </div>
    ...
    <select name="type" class="form-control" required>
        <option value="entrée" {{ $product->type == 'entrée' ? 'selected' : '' }}>Entrée</option>
        <option value="sortie" {{ $product->type == 'sortie' ? 'selected' : '' }}>Sortie</option>
    </select>
</div>
